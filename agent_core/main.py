...
from agent_core.tools.local_repo_tools import checkout_branch, reset_to_main, apply_changes_to_branch, push_changes
...
def main():
    ...
    for issue in issues:
        try:
            ...
            reset_to_main(context["files"]["fixed_files"])
